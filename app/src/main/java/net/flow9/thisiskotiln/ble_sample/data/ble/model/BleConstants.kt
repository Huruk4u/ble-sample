 ...
 */
object BleConstants {
    val SERVICE_UUID: UUID = UUID.fromString("0000aaaa-0000-1000-8000-00805F9B34aa")
    val CHARACTERISTIC_UUID: UUID = UUID.fromString("0000bbbb-0000-1000-8000-00805F9B3bbb")
}
